...
type virtualMachineInstancetypes struct {
	*gentype.ClientWithList[*v1alpha1.VirtualMachineInstancetype, *v1alpha1.VirtualMachineInstancetypeList]
}
...
func newVirtualMachineInstancetypes(c *InstancetypeV1alpha1Client, namespace string) *virtualMachineInstancetypes {
	return &virtualMachineInstancetypes{
		gentype.NewClientWithList[*v1alpha1.VirtualMachineInstancetype, *v1alpha1.VirtualMachineInstancetypeList](
			"virtualmachineinstancetypes",
			c.RESTClient(),
			scheme.ParameterCodec,
			namespace,
			func() *v1alpha1.VirtualMachineInstancetype { return &v1alpha1.VirtualMachineInstancetype{} },
			func() *v1alpha1.VirtualMachineInstancetypeList { return &v1alpha1.VirtualMachineInstancetypeList{} }),
	}
}
